...
Ce dossier documente les parties du projet liées à l'industrialisation de l'API : conteneurisation, intégration continue, sécurité et interface de démonstration.
...
- [`streamlit.md`](./streamlit.md) — le front-end de démonstration : les six pages, les modes dégradés quand un service est éteint, et le déroulé de soutenance qu'il permet.
